...
class MainMenu(GUI):
	def __init__(self, window):
		GUI.__init__(self)
		onePlayerMode = tk.Button(window, textvariable = msgs.SINGLE_PLAYER, font = ("Plantagenet Cherokee", 42), anchor = "center", width = 20, borderwidth = 10, relief = "groove", command = lambda  : singleplayer.Singleplayer(window))
