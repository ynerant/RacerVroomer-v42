...
class Settings(GUI):
	def __init__(self, window):
		...
		music = tk.Button(window, bg="#f8a1a1", textvariable = switchMusicMsg, font = ("Plantagenet Cherokee", 30), anchor = "center", width = 25, borderwidth = 10, relief = "groove")
		sounds = tk.Button(window, bg="#f8a1a1", textvariable = switchSoundsMsg, font = ("Plantagenet Cherokee", 30), anchor = "center", width = 25, borderwidth = 10, relief = "groove")
		changeLanguage = tk.Button(window, bg="#f8a1a1", textvariable = msgs.CHANGE_LANGUAGE,  font = ("Plantagenet Cherokee", 30), anchor = "center", width = 25, borderwidth = 10, relief = "groove", command = msgs.switchLanguage)
		controls = tk.Button(window, bg="#f8a1a1", textvariable = msgs.CHANGE_CONTROLS, font = ("Plantagenet Cherokee", 30), anchor = "center", width = 25, borderwidth = 10, relief = "groove", command = lambda : Controls(window))
		back = tk.Button(window, bg="#f8a1a1", textvariable = msgs.BACK, font = ("Plantagenet Cherokee", 30), anchor = "center", width = 25, borderwidth = 10, relief = "groove", command = lambda : guis.back(window))
...
class Controls(GUI):
	def __init__(self, window):
		...
		forward = tk.Button(window, bg="#f8a1a1", textvariable = forwardText, font = ("Plantagenet Cherokee", 21), width = 10)
		...
		left = tk.Button(window, bg="#f8a1a1", textvariable = leftText, font = ("Plantagenet Cherokee", 21), width = 10)
		...
		backward = tk.Button(window, bg="#f8a1a1", textvariable = backwardText, font = ("Plantagenet Cherokee", 21), width = 10)
		...
		right = tk.Button(window, bg="#f8a1a1", textvariable = rightText, font = ("Plantagenet Cherokee", 21), width = 10)

		back = tk.Button(window,bg="#f8a1a1", textvariable = msgs.BACK, font = ("Plantagenet Cherokee", 21), anchor = "center", width = 50, borderwidth = 10, relief = "groove", command = lambda : guis.back(window))
